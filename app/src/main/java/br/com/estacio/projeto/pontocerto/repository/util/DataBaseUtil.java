...
public class DataBaseUtil extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        stringBuilderCreateTable.append("        data           DATE          NOT NULL,            ");
        stringBuilderCreateTable.append("        tipo_evento    INT                   ,            ");
        stringBuilderCreateTable.append("        data_horario   DATETIME      NOT NULL,            ");
        stringBuilderCreateTable.append("        latitude       DOUBLE        NOT NULL,            ");
        stringBuilderCreateTable.append("        longitude      DOUBLE        NOT NULL,            ");
        stringBuilderCreateTable.append("        id_usuario     INT           NOT NULL)            ");
